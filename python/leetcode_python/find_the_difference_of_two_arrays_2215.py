...
class DifferenceOfArrays:
    ...
    def find_the_difference_of_two_arrays(self) -> list:
        answer = [list(set([item for item in self.input_data[0] if item not in self.input_data[1]])),
                  list(set([item for item in self.input_data[1] if item not in self.input_data[0]]))]
